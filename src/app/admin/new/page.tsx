    ...
    try {
      const res = await fetch("/api/articles", {
        ...
        body: JSON.stringify({
          ...
          author,
          authorAvatar,
          readTime: isVideo ? parseInt(videoDuration) || 0 : readTime,
          isFeatured,
          isPublished,
          categoryId,
          tags,
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Buat artikel atau video berita baru</p>
        </div>
      </div>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  Gunakan **text** untuk bold, *text* untuk italic, ## untuk heading
                </p>
              </CardContent>
            </Card>
