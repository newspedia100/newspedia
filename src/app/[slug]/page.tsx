...
import { ArticleContent } from "@/components/newspedia/ArticleContent";
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1">
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {/* Featured Image - Using regular img tag for ImgBB compatibility */}
          <motion.figure
          ...
          >
            ...
            {article.imageAlt && (
              <figcaption className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4 pt-12">
                <p className="text-white text-sm italic">{article.imageAlt}</p>
              </figcaption>
            )}
          </motion.figure>
